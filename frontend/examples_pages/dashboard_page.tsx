...
export default function CampanaLMSHome() {
  ...
  const [selectedPinout, setSelectedPinout] = useState<Pinout | null>(null);
  const [q, setQ] = useState("");

  // Static data memoized once
  const pinouts: Pinout[] = useMemo(
    () => [
      {
        id: "xlr-3pin",
  ...
  function showPinout(pinout: Pinout) {
    setSelectedPinout(pinout);
    setView("pinout");
  }
  function goBack() {
    setView((v) => (v === "pinout" ? "list" : "welcome"));
  }
      ...
      <header className="sticky top-0 z-10 border-b bg-white">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3">
          ...
          <div className="hidden items-center gap-2 md:flex">
            <button className="rounded-lg border px-3 py-2 text-sm hover:bg-gray-50" aria-label="Open docs">
              Docs
            </button>
            <button className="rounded-lg border px-3 py-2 text-sm hover:bg-gray-50" aria-label="Open admin">
              Admin
            </button>
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
                <div className="mb-3 flex items-center gap-2">
                  <CircleC className="h-5 w-5" aria-hidden="true" />
              ...
              <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
                ...
                <ul className="space-y-2 text-sm">
                  <li
                    ...
                    onClick={() => {
                      const p = pinouts.find((x) => x.id === "xlr-3pin");
                      if (p) showPinout(p);
                    }}
                  >
            ...
            {view === "welcome" && (
              <div className="rounded-lg border border-gray-200 bg-white p-12 text-center shadow-sm">
                <div className="mx-auto max-w-md">
                  <div className="mb-6 inline-flex h-16 w-16 items-center justify-center rounded-full bg-[#09a8e71b]">
                    <SparkIcon className="h-8 w-8 text-[#09A7E7]" aria-hidden="true" />
                  </div>
              ...
              <div className="rounded-lg border border-gray-200 bg-white shadow-sm">
                <div className="border-b border-gray-200 px-6 py-4 flex items-center justify-between gap-3">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    />
                    <button onClick={goBack} className="text-sm text-gray-600 hover:text-gray-900" aria-label="Back">
                      ← Back
                    </button>
                  </div>
                </div>
                    ...
                    filtered.map((pinout) => (
                      ...
                      >
                        <div className="flex items-center justify-between">
                          ...
                          <ArrowIcon className="h-5 w-5 text-gray-400" aria-hidden="true" />
                        </div>
                      </button>
                    ))
                  )}
              ...
              <div className="rounded-lg border border-gray-200 bg-white shadow-sm">
                <div className="border-b border-gray-200 bg-gray-900 px-6 py-4 text-white">
                  <div className="flex items-center justify-between">
                    ...
                    <button onClick={goBack} className="text-sm text-gray-300 hover:text-white" aria-label="Back to list">
                      ← Back to List
                    </button>
                  </div>
                </div>
                    ...
                    <div className="rounded-lg border border-gray-200 overflow-hidden">
                      <table className="w-full">
                        ...
                        <tbody className="divide-y divide-gray-200">
                          {selectedPinout.data.pins.map((pin) => (
                    ...
                    <div>
                      ...
                      <div className="rounded-lg bg-gray-50 p-4">
                        <ul className="space-y-2">
                          {selectedPinout.data.applications.map((app, idx) => (
...
function Logo() {
  return (
    <div className="grid h-8 w-8 place-items-center rounded-lg bg-slate-900 text-white" aria-label="Campana logo">
